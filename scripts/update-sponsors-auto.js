    ...
    if (process.env.GITHUB_TOKEN) {
      ...
      try {
        ...
        if (prResult) {
          ...
          console.log(`📊 Total changes: +${changeResult.changeSummary.added.length} -${changeResult.changeSummary.removed.length} ~${changeResult.changeSummary.modified.length}`);
